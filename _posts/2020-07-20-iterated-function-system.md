...
date: 2020-07-20
permalink: /posts/2020/07/iterated-function-system/
tags:
  - math
  - probability
  - stochastic
...
Consider a finite set\(S\) and finitely many functions \( f_i : 1 \le i \le k \) from \(S\) to \(S\) and a probability vector {% raw %) \( p_i : 1 \le i \le k \) {% endraw %} .
